...
if (account.pendingBalance < amount) throw new Error('Insufficient pending balance');
...
module.exports = { computeBalances, getOrCreateAccount, addLedgerEntry, settleOrderEarnings };