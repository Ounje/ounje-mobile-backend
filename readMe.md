# Authentication Flow
    ...
    4. if successful the backend responds with a jwt containing the email as payload which lasts for 30m.
    ...
    7. The frontend stores the jwt and passes it in the authorization header of a request to get the user information.
    ...
    5. The frontend stores the jwt and passes it in the authorization header of a request to get the user information if needed.

# Getting Users

    #Customer
    1. The frontend sends the jwt in an authorization header to api/customers/profile

    #Vendor
    1. The frontend sends the jwt in an authorization header to api/vendors/profile
